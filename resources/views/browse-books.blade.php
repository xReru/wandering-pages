...
@section('content')
    ...
    <div class="container mx-auto px-2 sm:px-4 py-8">
        <h1 class="font-['EBGaramond'] text-2xl sm:text-3xl md:text-4xl font-bold text-[#1B1146] mb-6">Browse All Books</h1>
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8 bg-[#F9F8FF] rounded-lg px-4 py-3">
            <div x-data="{ 
            ...
            class="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                <div>
                    ...
                    <select name="genre" id="genre" x-model="genre" class="bg-white mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring focus:ring-purple-200 focus:ring-opacity-50 font-['EBGaramond'] text-lg py-2 px-4">
                ...
                <div>
                    ...
                    <select name="sort" id="sort" x-model="sort" class="bg-white mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring focus:ring-purple-200 focus:ring-opacity-50 font-['EBGaramond'] text-lg py-2 px-2">

        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-6 sm:p-8" x-data="{ showPassword: false }">
                <form action="{{ route('admin.login.submit') }}" method="POST" class="space-y-6">
                    ...
                    <!-- Submit Button -->
                    <button type="submit" 
                        class="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-[#7464B6] hover:bg-[#6354A0] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-150 ease-in-out">
                        Sign in
                    </button>
                </form>
            </div>

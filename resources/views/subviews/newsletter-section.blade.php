...
<section class="bg-white py-16 px-4">
    <div class="container mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
        <div class="md:w-1/2 mb-8 md:mb-0">
            <h2 class="text-4xl font-bold text-gray-900 mb-2 font-primary">Don’t Miss a Page!</h2>
            <p class="text-2xl font-semibold text-gray-800 font-primary">Sign up for our newsletter.</p>
        </div>
        @if(session('success'))
            <script>

    ...
    <div class="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6">
        ...
        @if($orders->isEmpty())
            <div class="bg-white rounded-lg shadow-sm p-4 sm:p-6 text-center">
                <p class="text-gray-500 text-sm sm:text-base">You have no shipping orders.</p>
                    ...
                    <div class="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
                        <div class="p-4 sm:p-5">
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4 mb-3">
                                ...
                                <span class="self-start sm:self-center px-3 py-1 rounded-full text-xs font-medium bg-blue-50 text-blue-700 border border-blue-100">
                                    Shipping
                                </span>
                            </div>

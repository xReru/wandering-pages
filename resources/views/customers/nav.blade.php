    ...
    <div class="flex flex-col md:flex-row min-h-screen bg-purple-50">
        ...
        <aside class="w-full md:w-64 bg-white shadow-md p-6 flex-shrink-0">
            ...
            <nav class="flex flex-col gap-4">
                ...
                <a href="#" class="flex items-center gap-2 text-blue-600 font-medium hover:text-blue-800"><i class="fas fa-clock"></i> Pending</a>
                <a href="#" class="flex items-center gap-2 text-orange-500 font-medium hover:text-orange-700"><i class="fas fa-shipping-fast"></i> Shipping</a>
                <a href="#" class="flex items-center gap-2 text-blue-400 font-medium hover:text-blue-600"><i class="fas fa-truck"></i> Delivering</a>
        ...
        <section class="flex-1 p-8">
            @include('customers.profile-info')
        </section>
    </div>
@endsection

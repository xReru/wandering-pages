    ...
    <div class="bg-white rounded-lg shadow-md p-8 flex flex-col md:flex-row gap-8 items-center">
        ...
        <div class="flex-1 w-full">
            ...
            <div class="space-y-2">
                ...
                <div><span class="font-medium text-gray-600">Password:</span> ******** <a href="#" class="text-purple-700 text-xs font-semibold ml-2" @click.prevent="openChangePassword = true">change</a></div>
            </div>
